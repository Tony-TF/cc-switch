...
export function AboutSection({ isPortable }: AboutSectionProps) {
  ...
  return (
    <section className="space-y-6">
      ...
      <div className="rounded-xl border border-border bg-card/60 p-6 space-y-5 shadow-sm">
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4 px-1">
            {TOOL_NAMES.map((toolName) => {
              ...
              return (
                <div
                  key={toolName}
                  className="flex flex-col gap-2 rounded-xl border border-border bg-card/60 p-4 shadow-sm transition-colors hover:border-primary/30"
                >
